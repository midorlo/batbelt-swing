 ...
 * represent the item being dragged (restricted to the {@link Window}
...
public abstract class DragHandler 
    ...
    /** {etTransferable(DropTargetDragEvent)} returns this value when
    ...
    private furbelow.GhostedDragImage ghost;
